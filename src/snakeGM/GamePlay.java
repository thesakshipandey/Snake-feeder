...
//Part1_2
	...
	public void paint(Graphics g) {
		...
		//draw title image
		titleImage = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\title.png");
		...
		for(int i = 0; i< lengthofsnake; i++)
		{
			if(i==0 && right)
			{
				headRight = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\headRight.png");
				headRight.paintIcon(this,g , snakeXlength[i], snakeYlength[i]);
				
			}
			if(i==0 && left)
			{
				headLeft = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\headLeft.png");
				headLeft.paintIcon(this,g , snakeXlength[i], snakeYlength[i]);
				
			}
			if(i==0 && down)
			{
				headDown = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\headDown.png");
				headDown.paintIcon(this,g , snakeXlength[i], snakeYlength[i]);
				
			}
			if(i==0 && up)
			{
				headUp = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\headUp.png");
				headUp.paintIcon(this,g , snakeXlength[i], snakeYlength[i]);
				
			}
			if(i!=0)
			{
				tail = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\tail.png");
		...
		//Part3
		//Part5
		fruitimage = new ImageIcon("C:\\Users\\HP\\eclipse-workspace\\snakeGM\\src\\snakeGM\\fruit.png");
